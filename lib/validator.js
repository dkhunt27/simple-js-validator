...
var Validator = module.exports = function() {
     ...
     * @returns {void}
     */
    var assertIsDefined = function(toAssertName, toAssertObj){
     ...
     * @returns {void}
     */
    var assertIsNotDefined = function(toAssertName, toAssertObj){
     ...
     * @returns {void}
     */
    var assertIsNotEmpty = function(toAssertName, toAssertObj){
     ...
     * @returns {void}
     */
    var assertIsEmpty = function(toAssertName, toAssertObj){
    ...
    return {
        ...
        assertIsEmpty: assertIsEmpty,
        assertIsNotEmpty: assertIsNotEmpty,
        assertIsDefined: assertIsDefined,
        assertIsNotDefined: assertIsNotDefined
    };
}();