        ...
        describe('given fnInputs defined;', function() {
            ...
            describe('given inputsToValidate is an array and not all defined;', function() {
                ...
                beforeEach(function(){
                    ...
                    expErr = functionName + " validateInputsAreDefined[Async] following input must be defined: d";
                });
                describe('when sync called', function() {
                    var errCaught, errThrown, resultsReturned, errReturned;
                    beforeEach(function(){
        ...
        describe('given fnInputs defined;', function() {
            ...
            describe('given inputsToValidate is an array and one is empty;', function() {
                ...
                beforeEach(function(){
                    ...
                    expErr = functionName + " validateInputsAreNotEmpty[Async] following input must not be empty: a";
                });
                describe('when sync called', function() {
                    var errCaught, errThrown, resultsReturned, errReturned;
                    beforeEach(function(){
            ...
            describe('given inputsToValidate is an array and one nested is empty;', function() {
                ...
                beforeEach(function(){
                    ...
                    expErr = functionName + " validateInputsAreNotEmpty[Async] following input must not be empty: c.f.h";
                });
                describe('when sync called', function() {
                    var errCaught, errThrown, resultsReturned, errReturned;
                    beforeEach(function(){
